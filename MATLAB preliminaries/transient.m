...
plot(fexc/Fs,db(G_actual_exc-Gest(:,1)),'r.--','Markersize',15,'Displayname',"|G_{est}-G| (1st period)")
plot(fexc/Fs,db(G_actual_exc-Gest(:,P)),'ms:','Markersize',12,'Displayname',"|G_{est}-G| (" + P + "th period)")
xlabel('Normalized frequency')
plot_options(gca)
title("Magnitude (dB)")
legend('Location','Best')
print(gcf,'figures/MS_G_transients','-depsc')

transient_analysis(y_rep,P)
set(gca,'yscale','log')
grid off
plot_options(gca)
print(gcf,'figures/MS_transients_RMS_error','-depsc')
